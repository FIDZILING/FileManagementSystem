...
public class BrowserFrame extends JFrame {
	...
	//
	// public BrowserFrame(String frameTilte, JFrame parentframe, User user) {
	...
	public BrowserFrame(String frameTilte, JFrame parentframe, User user) {
		...
		mi11.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				new ChangeInfoSelf("修改个人的信息", BrowserFrame.this, user);
		...
		mi22.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				new ChangeFile2("下载文件", BrowserFrame.this, user);
				BrowserFrame.this.setVisible(false);
			}
